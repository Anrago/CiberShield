        ...
        <div className="flex flex-col w-5/6 gap-2 mt-3">
          ...
          <div className="mt-4">
            ...
            <ol className="list-decimal list-inside text-xl text-gray-700 space-y-2">
              <li>El atacante se hace pasar por una entidad confiable (banco, red social, etc.).</li>
              <li>Envía un mensaje con un enlace o archivo malicioso.</li>
              <li>La víctima accede al enlace o descarga el archivo.</li>
              <li>Ingresa su información sin sospechar que es un sitio falso.</li>
              <li>El atacante roba los datos y puede usarlos o venderlos.</li>
            </ol>
          </div>

          <div className="flex justify-center m-8">
            <img src={ImageTemp} alt="Phishing" className="w-64 h-auto rounded-lg shadow-lg" />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4 text-xl text-gray-700">
            {[
              { titulo: "Phishing por correo", desc: "Utiliza correos electrónicos falsos para engañar al usuario." },
              { titulo: "Smishing (SMS)", desc: "Ataques mediante mensajes de texto falsos." },
              { titulo: "Vishing (llamadas)", desc: "Fraudes a través de llamadas telefónicas." },
              { titulo: "Spear phishing", desc: "Ataques dirigidos a una persona específica o grupo reducido." },
              { titulo: "Pharming", desc: "Redirecciona al usuario a sitios falsos sin que lo note." },
              { titulo: "Phishing en redes sociales", desc: "Utiliza perfiles o mensajes engañosos en redes sociales." }
            ].map(({ titulo, desc }) => (
              <div key={titulo} className="p-4 border rounded shadow bg-gray-50">
          ...
          <div className="flex justify-center m-8">
            <img src={ImageTemp} alt="Protección contra phishing" className="w-64 h-auto rounded-lg shadow-lg" />
          </div>
        </div>
      </div>
    </div>
